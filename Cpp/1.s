...
.lcomm _ZZ4funcvE1p,4,4
.lcomm _ZGVZ4funcvE1p,8,8
.LC0:
	.ascii "p = %d\12\0"
	.text
	.globl	_Z4funcv
...
.LFB1494:
	...
	.seh_stackalloc	32
	.seh_endprologue
	movzbl	_ZGVZ4funcvE1p(%rip), %eax
	testb	%al, %al
	sete	%al
	testb	%al, %al
	je	.L2
	leaq	_ZGVZ4funcvE1p(%rip), %rcx
...
.LEHB0:
	call	_Z3foov
.LEHE0:
	movl	%eax, _ZZ4funcvE1p(%rip)
	leaq	_ZGVZ4funcvE1p(%rip), %rcx
	call	__cxa_guard_release
.L2:
	movl	_ZZ4funcvE1p(%rip), %eax
	movl	%eax, %edx
	leaq	.LC0(%rip), %rcx
.LEHB1:
	call	printf
